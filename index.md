...
<body>
    <script src="https://kit.fontawesome.com/82efb0425c.js" crossorigin="anonymous"></script>
    <style>
        :root{
            --primary-color :  #d23069;
            --secondary-color : #bf1d56;
            --orange-color: #ffc351;
        }
        body{
        ...
        .navbar .lists .sign-in:hover{
            background-color: var(--secondary-color);
        }
        .navbar .lists .sign-up{
    ...
    <div class="first-block">
        ...
        <div class="right-coloum">
            <img src="images/icecreamman.png" alt="">
        </div>
    </div>
    <section class="second-block">
        <div class="left-coloum">
            <div class="img-text">
                <div class="left-img">
                    <img src="images/leftimage.png" alt="Image">
                </div>
    ...
    <div class="third-block">
        ...
        <section class="section1">
            <div class="images">
                <div class="image1">
                    <img src="images/image1.png" alt="image1" width=250px>
                ...
                <div class="image2">
                    <img src="images/image2.png" alt="image2" width=250px>
                ...
                <div class="image3">
                    <img src="images/image3.png" alt="image1" width=250px>
